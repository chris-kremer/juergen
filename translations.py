...
TRANSLATIONS = {
    'en': {
        ...
        'tax_simulation_disclaimer': 'Simplified estimate only. One liquidation-tax liability is calculated from the pooled portfolio tax basis and allocated among owners in proportion to positive earnings above confirmed investment. The 25% equivalent is the hypothetical value whose gain would leave the same net amount after 25% tax. Excluded are church tax, allowances, loss-pot restrictions, transaction costs and fund-specific partial exemptions.',
    ...
    'de': {
        ...
        'tax_simulation_disclaimer': 'Nur eine vereinfachte Schätzung. Aus der steuerlichen Basis des Gesamtportfolios wird eine gemeinsame Liquidationssteuer berechnet und im Verhältnis der positiven Erträge über dem bestätigten Investment verteilt. Das 25-%-Äquivalent ist der hypothetische Wert, dessen Gewinn nach 25 % Steuer denselben Nettobetrag ergibt. Nicht berücksichtigt sind Kirchensteuer, Freibeträge, Beschränkungen der Verlusttöpfe, Transaktionskosten und fondsspezifische Teilfreistellungen.',
