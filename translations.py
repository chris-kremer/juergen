...
TRANSLATIONS = {
    'en': {
        ...
        'tax_overview_description': 'Estimated tax if the complete portfolio were sold now. Tax is applied only to the net unrealized gain, not to the full asset value.',
        ...
        'gross_up_reference': '{:.3g}% gross-up reference',
        'gross_up_short': 'Gross-up reference',
        'tax_value_comparison': 'Current, after-tax and grossed-up values',
        'tax_simulation_disclaimer': 'Simplified estimate only. It allocates the pooled portfolio tax basis pro rata and excludes church tax, allowances, existing loss pots, previously prepaid tax, transaction costs and fund-specific partial exemptions. The gross-up reference divides current value by one minus the selected rate; it is hypothetical and not an account balance.',
    ...
    'de': {
        ...
        'tax_overview_description': 'Geschätzte Steuer bei einem sofortigen Verkauf des gesamten Portfolios. Besteuert wird nur der nicht realisierte Nettogewinn, nicht der gesamte Vermögenswert.',
        ...
        'gross_up_reference': '{:.3g} % hochgerechneter Referenzwert',
        'gross_up_short': 'Hochgerechneter Referenzwert',
        'tax_value_comparison': 'Aktueller, versteuerter und hochgerechneter Wert',
        'tax_simulation_disclaimer': 'Nur eine vereinfachte Schätzung. Die steuerliche Basis des Gesamtportfolios wird anteilig verteilt. Nicht berücksichtigt sind Kirchensteuer, Freibeträge, Verlusttöpfe, bereits vorausbezahlte Steuern, Transaktionskosten und fondsspezifische Teilfreistellungen. Der hochgerechnete Referenzwert teilt den aktuellen Wert durch eins minus den gewählten Satz; er ist hypothetisch und kein Kontostand.',
